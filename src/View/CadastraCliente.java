...
public class CadastraCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jbnovo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/irc-join.png"))); // NOI18N
        jbnovo.setText("Novo");
        ...
        jbsalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/file.png"))); // NOI18N
        ...
        jbcancelar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/status-offline.png"))); // NOI18N
 ...
 private boolean validarCampos() {
    ...
    private boolean preencherObject() throws Exception {
        ...
        obj.setSexo(jcsexo.getSelectedIndex());
        obj.setContato(jtcontato.getText());
        obj.setEndereco(jtendereco.getText());
        obj.setUF(jcUF.getSelectedIndex());
        obj.setBairro(jtbairro.getText());
        obj.setCidade(jtcidade.getText());
        obj.setEmail(jtendereco.getText());
        obj.setCEP(jtCEP.getText());
